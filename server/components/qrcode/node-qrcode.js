...
const QRCode = function (t) {
  ...
  var v = l,
    ...
    r.getRowColCoords = function (t) {
      ...
      for (var r = Math.floor(t / 7) + 2, n = e(t), o = 145 === n ? 26 : 2 * Math.ceil((n - 13) / (2 * r - 2)), i = [n - 7], a = 1; a < r - 1; a++) i[a] = i[a - 1] - o;
    ...
    r.isValid = function (t) {
      ...
      for (var r = t.size, n = 0, o = 0, i = 0, a = null, u = null, s = 0; s < r; s++) {
        o = i = 0, a = u = null;

        for (var f = 0; f < r; f++) {
          var h = t.get(s, f);
          h === a ? o++ : (o >= 5 && (n += e + (o - 5)), a = h, o = 1), (h = t.get(f, s)) === u ? i++ : (i >= 5 && (n += e + (i - 5)), u = h, i = 1);
        }
      ...
      for (var r = t.size, e = 0, o = 0; o < r - 1; o++) for (var i = 0; i < r - 1; i++) {
      ...
      for (var r = t.size, e = 0, n = 0, i = 0, a = 0; a < r; a++) {
        ...
        for (var u = 0; u < r; u++) n = n << 1 & 2047 | t.get(a, u), u >= 10 && (1488 === n || 93 === n) && e++, i = i << 1 & 2047 | t.get(u, a), u >= 10 && (1488 === i || 93 === i) && e++;
      }
      ...
      for (var e = r.size, n = 0; n < e; n++) for (var o = 0; o < e; o++) r.isReserved(o, n) || r.xor(o, n, a(t, o, n));
  ...
  !function () {
    for (var t = 1, r = 0; r < 255; r++) M[r] = t, N[t] = r, 256 & (t <<= 1) && (t ^= 285);
  ...
  var L = T,
    ...
    return !isNaN(t) && t >= 1 && t <= 40;
      ...
      U = "[0-9]+",
      x = "(?:[u3000-u303F]|[u3040-u309F]|[u30A0-u30FF]|[uFF00-uFFEF]|[u4E00-u9FAF]|[u2605-u2606]|[u2190-u2195]|u203B|[u2010u2015u2018u2019u2025u2026u201Cu201Du2225u2260]|[u0391-u0451]|[u00A7u00A8u00B1u00B4u00D7u00F7])+",
      k = "(?:(?![A-Z0-9 $%*+\\-./:]|" + (x = x.replace(/u/g, "\\u")) + ")(?:.|[\r\n]))+",
      F = new RegExp(x, "g"),
      S = new RegExp(k, "g"),
      _ = new RegExp(U, "g"),
      Y = new RegExp("[A-Z $%*+\\-./:]+", "g"),
    ...
    r.NUMERIC = {
      ...
      return H.testNumeric(t) ? r.NUMERIC : H.testAlphanumeric(t) ? r.ALPHANUMERIC : H.testKanji(t) ? r.KANJI : r.BYTE;
    ...
    r.from = function (t, r) {
      ...
      if (Array.isArray(t)) {
        if (t.length > 1) return function (t, e) {
          for (var n = 1; n <= 40; n++) if (o(t, n) <= r.getCapacity(n, e, K.MIXED)) return n;
        }(t, i);
      ...
      Q = a(1335),
      q = function (t, r) {
    for (var e = t.bit << 3 | r, n = e << 10; a(n) - Q >= 0;) n ^= 1335 << a(n) - Q;
  ...
  function W(t) {
    this.mode = K.BYTE, this.data = new Uint8Array(function (t) {
  ...
  tt.getBitsLength = function (t) {
    ...
    for (r = 0; r < this.data.length; r++) {
      var e = f(this.data[r]);
      if (e >= 33088 && e <= 40956) e -= 33088;else {
  ...
  var rt = tt,
    ...
    var r = {
      single_source_shortest_paths: function (t, e, n) {
        ...
        for (d.push(e, 0); !d.empty();) for (s in u = (a = d.pop()).value, f = a.cost, h = t[u] || {}) h.hasOwnProperty(s) && (c = f + h[s], g = i[s], (void 0 === i[s] || g > c) && (i[s] = c, d.push(s, c), o[s] = u));
    ...
    function o(t) {
      ...
      return s() ? (r = n(H.BYTE, K.BYTE, t), e = n(H.KANJI, K.KANJI, t)) : (r = n(H.BYTE_KANJI, K.BYTE, t), e = []), o.concat(i, r, e).sort(function (t, r) {
    ...
    r.fromArray = function (t) {
      return t.reduce(function (t, r) {
        return "string" == typeof r ? t.push(a(r, null)) : r.data && t.push(a(r.data, r.mode)), t;
      }, []);
      ...
      for (var a = function (t, r) {
        for (var e = {}, n = {
          ...
          for (var u = t[a], s = [], f = 0; f < u.length; f++) {
            ...
            for (var g = 0; g < o.length; g++) {
              var d = o[g];
              e[d] && e[d].node.mode === h.mode ? (n[d][c] = i(e[d].lastCount + h.length, h.mode) - i(e[d].lastCount, h.mode), e[d].lastCount += h.length) : (e[d] && (e[d].lastCount = h.length), n[d][c] = i(h.length, h.mode) + 4 + K.getCharCountIndicator(h.mode, r));
            }
          }
        ...
        return r;
      }(o(t, s())), n), u = et.find_path(a.map, "start", "end"), f = [], h = 1; h < u.length - 1; h++) f.push(a.table[u[h]].node);
  ...
  function it(t, r, e) {
    ...
    for (var a = (o - n.getLengthInBits()) / 8, u = 0; u < a; u++) n.put(u % 2 ? 17 : 236, 8);

    return function (t, r, e) {
      for (var n = i(r), o = I(r, e), a = n - o, u = B(r, e), s = u - n % u, f = Math.floor(n / u), h = Math.floor(a / u), c = h + 1, g = f - h, d = new L(g), l = 0, v = new Array(u), p = new Array(u), w = 0, m = new Uint8Array(t.buffer), E = 0; E < u; E++) {
        var y = E < s ? h : c;
      ...
      for (A = 0; A < w; A++) for (M = 0; M < u; M++) A < v[M].length && (N[C++] = v[M][A]);
  ...
  function at(t, r, e, n) {
    var i;
    if (Array.isArray(t)) i = nt.fromArray(t);else {
    ...
    var f = it(r, e, i),
        ...
        c = new v(h);
    return function (t, r) {
      for (var e = t.size, n = m(r), o = 0; o < n.length; o++) for (var i = n[o][0], a = n[o][1], u = -1; u <= 7; u++) if (!(i + u <= -1 || e <= i + u)) for (var s = -1; s <= 7; s++) a + s <= -1 || e <= a + s || (u >= 0 && u <= 6 && (0 === s || 6 === s) || s >= 0 && s <= 6 && (0 === u || 6 === u) || u >= 2 && u <= 4 && s >= 2 && s <= 4 ? t.set(i + u, a + s, !0, !0) : t.set(i + u, a + s, !1, !0));
    }(c, r), function (t) {
      ...
      for (var e = p.getPositions(r), n = 0; n < e.length; n++) for (var o = e[n][0], i = e[n][1], a = -2; a <= 2; a++) for (var u = -2; u <= 2; u++) -2 === a || 2 === a || -2 === u || 2 === u || 0 === a && 0 === u ? t.set(o + a, i + u, !0, !0) : t.set(o + a, i + u, !1, !0);
    }(c, r), ot(c, e, 0), r >= 7 && function (t, r) {
      for (var e, n, o, i = t.size, a = O.getEncodedBits(r), u = 0; u < 18; u++) e = Math.floor(u / 3), n = u % 3 + i - 8 - 3, o = 1 == (a >> u & 1), t.set(e, n, o, !0), t.set(n, e, o, !0);
    }(c, r), function (t, r) {
      for (var e = t.size, n = -1, o = e - 1, i = 7, a = 0, u = e - 1; u > 0; u -= 2) for (6 === u && u--;;) {
        for (var s = 0; s < 2; s++) if (!t.isReserved(o, u - s)) {
          var f = !1;
          a < r.length && (f = 1 == (r[a] >>> i & 1)), t.set(o, u - s, f), -1 == --i && (a++, i = 7);
        }
  ...
  var ut = function (t, r) {
    ...
    var e,
        n,
        o = c.M;
    return void 0 !== r && (o = c.from(r.errorCorrectionLevel, c.M), e = O.from(r.version), n = E.from(r.maskPattern), r.toSJISFunc && u(r.toSJISFunc)), at(t, e, o, n);
  },
      st = h(function (t, r) {
    function e(t) {
    ...
    r.getOptions = function (t) {
      ...
      for (var o = e.modules.size, i = e.modules.data, a = r.getScale(o, n), u = Math.floor((o + 2 * n.margin) * a), s = n.margin * a, f = [n.color.light, n.color.dark], h = 0; h < u; h++) for (var c = 0; c < u; c++) {
        var g = 4 * (h * u + c),
            d = n.color.light;
        if (h >= s && c >= s && h < u - s && c < u - s) d = f[i[Math.floor((h - s) / a) * o + Math.floor((c - s) / a)] ? 1 : 0];
    ...
    r.render = function (t, r, e) {
      ...
      return st.qrToImageData(u.data, t, n), function (t, r, e) {
  ...
  var gt = function (t, r, e) {
    var n = st.getOptions(r),
        ...
        i = t.modules.data,
        a = o + 2 * n.margin,
        u = n.color.light.a ? "<path " + ht(n.color.light, "fill") + ' d="M0 0h' + a + "v" + a + 'H0z"/>' : "",
        s = "<path " + ht(n.color.dark, "stroke") + ' d="' + function (t, r, e) {
      for (var n = "", o = 0, i = !1, a = 0, u = 0; u < t.length; u++) {
        var s = Math.floor(u % r),
            f = Math.floor(u / r);
        s || i || (i = !0), t[u] ? (a++, u > 0 && s > 0 && t[u - 1] || (n += i ? ct("M", s + e, .5 + f + e) : ct("m", o, 0), o = 0, i = !1), s + 1 < r && t[u + 1] || (n += ct("h", a), a = 0)) : o++;
      }
  ...
  function dt(t, r, n, o, i) {
    ...
    if (!s) {
      ...
      return 1 === u ? (n = r, r = o = void 0) : 2 !== u || r.getContext || (o = n, n = r, r = void 0), new Promise(function (e, i) {
        try {
          var a = ut(n, o);
          e(t(a, r, o));
        } catch (t) {
    ...
    2 === u ? (i = n, n = r, r = o = void 0) : 3 === u && (r.getContext && void 0 === i ? (i = o, o = void 0) : (i = o, o = n, n = r, r = void 0));
