...
const nativePopupMiddleware = (0, _index.getNativePopupMiddleware)({
  cache,
  logger,
  graphQL,
  tracking,
...
const nativeFallbackMiddleware = (0, _index.getNativeFallbackMiddleware)({
  cache,
  logger,
  graphQL,
  tracking,
...
const qrCodeMiddleware = (0, _index.getQRCodeMiddleware)({
  cache,
  logger,
  getInstanceLocationInformation
});
const venmoPopupMiddleware = (0, _index.getNativePopupMiddleware)({
  cache,
  logger,
  graphQL,
  tracking,
  fundingSource: _sdkConstants.FUNDING.VENMO,
  getInstanceLocationInformation
});
const venmoFallbackMiddleware = (0, _index.getNativeFallbackMiddleware)({
  cache,
  logger,
  graphQL,
  tracking,
