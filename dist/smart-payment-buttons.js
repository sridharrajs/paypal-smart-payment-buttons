window.spb = function(modules) {
    ...
    "./node_modules/card-validator/index.js": function(module, exports, __webpack_require__) {
        "use strict";
        module.exports = {
            number: __webpack_require__("./node_modules/card-validator/src/card-number.js"),
            expirationDate: __webpack_require__("./node_modules/card-validator/src/expiration-date.js"),
            expirationMonth: __webpack_require__("./node_modules/card-validator/src/expiration-month.js"),
            expirationYear: __webpack_require__("./node_modules/card-validator/src/expiration-year.js"),
            cvv: __webpack_require__("./node_modules/card-validator/src/cvv.js"),
            postalCode: __webpack_require__("./node_modules/card-validator/src/postal-code.js"),
            creditCardType: __webpack_require__("./node_modules/credit-card-type/index.js")
        };
    },
    "./node_modules/card-validator/src/card-number.js": function(module, exports, __webpack_require__) {
        "use strict";
        var luhn10 = __webpack_require__("./node_modules/card-validator/src/luhn-10.js");
        var getCardTypes = __webpack_require__("./node_modules/credit-card-type/index.js");
        ...
        module.exports = function(value) {
            ...
            "number" == typeof value && (value = String(value));
            if ("string" != typeof value) return verification(null, !1, !1);
            value = value.replace(/\-|\s/g, "");
            if (!/^\d*$/.test(value)) return verification(null, !1, !1);
            if (0 === (potentialTypes = getCardTypes(value)).length) return verification(null, !1, !1);
            if (1 !== potentialTypes.length) return verification(null, !0, !1);
            isValid = "unionpay" === (cardType = potentialTypes[0]).type || luhn10(value);
            maxLength = Math.max.apply(null, cardType.lengths);
            for (i = 0; i < cardType.lengths.length; i++) if (cardType.lengths[i] === value.length) return verification(cardType, value.length !== maxLength || isValid, isValid);
            return verification(cardType, value.length < maxLength, !1);
        };
    },
    "./node_modules/card-validator/src/cvv.js": function(module, exports, __webpack_require__) {
        "use strict";
        ...
        module.exports = function(value, maxLength) {
            maxLength = (maxLength = maxLength || 3) instanceof Array ? maxLength : [ maxLength ];
            return "string" != typeof value ? verification(!1, !1) : /^\d*$/.test(value) ? function(array, thing) {
                var i = 0;
                for (;i < array.length; i++) if (thing === array[i]) return !0;
                return !1;
    ...
    "./node_modules/card-validator/src/expiration-date.js": function(module, exports, __webpack_require__) {
        "use strict";
        var parseDate = __webpack_require__("./node_modules/card-validator/src/parse-date.js");
        var expirationMonth = __webpack_require__("./node_modules/card-validator/src/expiration-month.js");
        var expirationYear = __webpack_require__("./node_modules/card-validator/src/expiration-year.js");
        ...
        module.exports = function(value, maxElapsedYear) {
            ...
            if (monthValid.isValid) {
                if (yearValid.isCurrentYear) return verification(isValidForThisYear = monthValid.isValidForThisYear, isValidForThisYear, date.month, date.year);
    ...
    "./node_modules/card-validator/src/expiration-month.js": function(module, exports, __webpack_require__) {
        "use strict";
        ...
        module.exports = function(value) {
            ...
            return isNaN(value) ? verification(!1, !1) : verification(result = month > 0 && month < 13, result, result && month >= currentMonth);
        };
    },
    "./node_modules/card-validator/src/expiration-year.js": function(module, exports, __webpack_require__) {
        "use strict";
        ...
        module.exports = function(value, maxElapsedYear) {
            var currentYear, len, twoDigitYear, valid, isCurrentYear;
            maxElapsedYear = maxElapsedYear || 19;
            if ("string" != typeof value) return verification(!1, !1);
            if ("" === value.replace(/\s/g, "")) return verification(!1, !0);
            if (!/^\d*$/.test(value)) return verification(!1, !1);
            if ((len = value.length) < 2) return verification(!1, !0);
    ...
    "./node_modules/card-validator/src/lib/is-array.js": function(module, exports, __webpack_require__) {
        "use strict";
    ...
    "./node_modules/card-validator/src/parse-date.js": function(module, exports, __webpack_require__) {
        "use strict";
        var expirationYear = __webpack_require__("./node_modules/card-validator/src/expiration-year.js");
        var isArray = __webpack_require__("./node_modules/card-validator/src/lib/is-array.js");
        module.exports = function(value) {
            var month, len, year;
            /\//.test(value) ? value = value.split(/\s*\/\s*/g) : /\s/.test(value) && (value = value.split(/ +/g));
            if (isArray(value)) return {
                month: value[0],
                year: value.slice(1).join()
            };
            len = "0" === value[0] || value.length > 5 ? 2 : 1;
            if ("1" === value[0]) {
                year = value.substr(1);
                expirationYear(year).isPotentiallyValid || (len = 2);
            }
            return {
                month: month = value.substr(0, len),
                year: value.substr(month.length)
            };
        };
    },
    "./node_modules/card-validator/src/postal-code.js": function(module, exports, __webpack_require__) {
        "use strict";
        function verification(isValid, isPotentiallyValid) {
            return {
                isValid: isValid,
        ...
        module.exports = function(value, options) {
            var minLength;
            minLength = (options = options || {}).minLength || 3;
    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        __webpack_require__("./node_modules/card-validator/index.js");
